...
API_KEY = "0353ad183a0db15c5c78e0f0463da4b27a9932e5"
API_SECRET = "54844bca23d404603d6937b586cf3e1b237576ee"


class DadataLiveTest(unittest.TestCase):
    """Tests that make real API calls to Dadata (count: 3 calls total)."""

    @classmethod
    def setUpClass(cls):
        os.environ["DADATA_API_KEY"] = API_KEY
        os.environ["DADATA_API_SECRET"] = API_SECRET
