...
> **Примечание по CI/CD:** в текущей версии проекта автоматический CI/CD-конвейер не реализован. Развёртывание выполняется локально через `docker compose`. Ниже в архитектурном разделе приведена рекомендуемая схема, как такой контур можно расширить в будущем.
